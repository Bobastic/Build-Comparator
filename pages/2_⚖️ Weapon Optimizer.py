...
cols=st.columns(8)
with cols[0]: st.number_input("Standard negation",0.,100.,st.session_state.negstandard,format="%.1f",step=0.1,key="negstandard_",on_change=updateState,args=("negstandard_",))
with cols[1]: st.number_input("Strike negation",0.,100.,st.session_state.negstrike,format="%.1f",step=0.1,key="negstrike_",on_change=updateState,args=("negstrike_",))
with cols[2]: st.number_input("Slash negation",0.,100.,st.session_state.negslash,format="%.1f",step=0.1,key="negslash_",on_change=updateState,args=("negslash_",))
with cols[3]: st.number_input("Pierce negation",0.,100.,st.session_state.negpierce,format="%.1f",step=0.1,key="negpierce_",on_change=updateState,args=("negpierce_",))
with cols[4]: st.number_input("Magic negation",0.,100.,st.session_state.negmagic,format="%.1f",step=0.1,key="negmagic_",on_change=updateState,args=("negmagic_",))
with cols[5]: st.number_input("Fire negation",0.,100.,st.session_state.negfire,format="%.1f",step=0.1,key="negfire_",on_change=updateState,args=("negfire_",))
with cols[6]: st.number_input("Lightning negation",0.,100.,st.session_state.neglightning,format="%.1f",step=0.1,key="neglightning_",on_change=updateState,args=("neglightning_",))
with cols[7]: st.number_input("Holy negation",0.,100.,st.session_state.negholy,format="%.1f",step=0.1,key="negholy_",on_change=updateState,args=("negholy_",))
