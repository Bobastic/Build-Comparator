...
with cols[0]: st.selectbox("Weapon class",weaponClasses,key="wClass",on_change=resetWeapon)
...
with bestInf:
    ...
    with plot:
        ...
        fig.update_layout(barmode='stack',legend_traceorder="normal",margin=go.layout.Margin(l=0,r=0,b=0,t=0),autosize=False,height=350,legend={"orientation":"h","yanchor":"bottom","y":1.02}) #autosize=False,height=350
