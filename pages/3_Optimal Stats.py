...
with bestInf:
    ...
    with cols[3]: st.toggle("Show AR",disabled=True,key="AR_")
    with plot[0]:
...
with bestStats:
    ...
    with cols[2]: st.info("A base Vagabond with 60 VIG and 27 END has 55 points left to allocate to reach RL 125.")
