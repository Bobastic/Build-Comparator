...
with info:
    ...
    fig.add_trace(go.Scatter(x=data.sum(axis=1),y=labels,text=[f" {d:.0f}" for d in data.sum(axis=1)],mode='text',textfont={"size":12},textposition="middle center",showlegend=False))
